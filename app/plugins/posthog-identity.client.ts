...
export default defineNuxtPlugin({
  ...
  setup() {
    ...
    // The marketing site (matriq.com) appends ?ph_consent=granted when the
    ...
    if (crossDomainConsent === 'granted') {
      ...
      if (document.referrer) {
        try {
          ...
          fromTrustedOrigin = ref.hostname === 'matriq.com' || ref.hostname.endsWith('.matriq.com')
        }
    ...
    // The marketing site (matriq.com) appends ?ph_did=<distinct_id> to links
